  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.tips}>
        <div>
          <img src={ProductViews} alt="Product Views" />
        </div>
        <div className={style.tips}>
          <img src={ProTips} alt="Pro Tips" />
          <img src={calcPurple} className={style.calcPurple} alt="Calc Purple" />
          <img src={calcRed} className={style.calcRed} alt="Calc Red" />
          <img src={calcOrange} className={style.calcOrange} alt="Calc Orange" />
        </div>
      </div>
    </div>
  );
